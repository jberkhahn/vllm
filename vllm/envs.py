...
if TYPE_CHECKING:
    ...
    VLLM_ADAPTER_DIR: Optional[str] = None
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # If set, vllm will look in this directory when it receives
    # a request for a lora adapter it doesn't recognize. Only
    # avilable if VLLM_ALLOW_RUNTIME_LORA_UPDATING is set
    "VLLM_ADAPTER_DIR":
    lambda: (None if os.getenv("VLLM_ADAPTER_DIR", None) is None or
             "VLLM_ALLOW_RUNTIME_LORA_UPDATING" not in os.environ else
             os.path.expanduser(os.getenv("VLLM_ADAPTER_DIR", "."))),
